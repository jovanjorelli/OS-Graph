...
export const InspectorDrawer: React.FC<InspectorDrawerProps> = ({
  ...
  return (
    <aside className="fixed inset-x-0 bottom-0 z-40 max-h-[58vh] sm:max-h-none sm:top-16 sm:right-4 sm:bottom-4 sm:w-[440px] sm:inset-x-auto bg-neutral-950/95 backdrop-blur-2xl border-t sm:border border-neutral-800/80 rounded-t-3xl sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-6 sm:slide-in-from-right-3 duration-200">
      <button
        onClick={onClose}
        className="w-full flex justify-center py-2 -mt-0.5 -mb-1 focus:outline-none sm:hidden shrink-0 cursor-pointer group"
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 text-xs">
        ...
        {selectedNode.description && (
          <div
            className="p-2.5 sm:p-3.5 rounded-xl bg-neutral-900/40 border border-neutral-800/80 text-[11px] sm:text-xs text-neutral-300 leading-relaxed"
